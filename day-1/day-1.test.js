const {heaviestElf, heaviestThreeElves} = require('./day-1')
...
describe("heaviestElf", () => {
    ...
    test("hopefully returns correct answer when given large test array", () => {
        const elves = [
            [6750, 
            6538,
            5292,
        ...
        expect(heaviestElf(elves)).toBe(70374);
    })
})
describe("heaviestThreeElves", () => {
    
    test("returns sum of highest 3 totals when more than one nested array is entered", () => {
        const elves = [[1000, 2000, 3000], [4000], [2000, 1000], [4000, 1000]];
        expect(heaviestThreeElves(elves)).toBe(15000);
        const moreElves = [[1000, 2000, 3000], [4000], [5000, 6000], 
        [7000, 8000, 9000], [10000]];
        expect(heaviestThreeElves(moreElves)).toBe(45000);
    })
    test("hopefully returns correct answer when given large test array", () => {
        const elves = [
            [6750, 
        ...
        expect(heaviestThreeElves(elves)).toBe(204610);
    })
})
